# AI Assistant Guidelines (.ai-instructions.md)

This file contains the core guidelines, deployment checklists, and protocols for AI assistants working on the DonaTalk project.
...
3. Version bumped in `package.json` + `docs/product-reference.md` + `docs/developer-reference.md`
...
### Env Var Reference
All env vars needed on Vercel:
`NEXT_PUBLIC_FIREBASE_API_KEY`, `NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN`, `NEXT_PUBLIC_FIREBASE_PROJECT_ID`, `FIREBASE_PROJECT_ID`, `FIREBASE_CLIENT_EMAIL`, `FIREBASE_PRIVATE_KEY`, `NEXT_PUBLIC_PAYPAL_CLIENT_ID`, `PAYPAL_CLIENT_ID`, `PAYPAL_CLIENT_SECRET`, `PAYPAL_API_URL`, `NEXT_PUBLIC_BASE_URL`, `EMAIL_PASSWORD`, `MEETING_TOKEN_SECRET`
