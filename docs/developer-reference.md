...
> Last updated: 2026-07-11 | Version: 0.18.0
...
| `/pitchers` | `app/pitchers/page.tsx` | SEO seller-side landing page: donation-based outreach for B2B sellers (static, FAQ JSON-LD) |
