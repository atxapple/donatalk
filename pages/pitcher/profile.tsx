            ...
            <PageWrapper>
                <CardContainer>
                    ...
                    <ShareSection>
                        ...
                        {pitcher.credit_balance < pitcher.donation && (
                            <div style={{ color: '#e74c3c', fontWeight: '600', marginTop: '0.5rem', marginBottom: '0.5rem' }}>
                                ⚠️ Your available fund is lower than your donation request per meeting. The sharable link will be inactive unless your fund covers the donation amount.
                            </div>
                        )}
